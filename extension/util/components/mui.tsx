...
// https://v5.mui.com/material-ui/react-tooltip/#variable-width
...
// TODO: Use CSS variables to prevent UI flickering when MUI v6 is supported
// https://mui.com/material-ui/customization/css-theme-variables/overview/
// https://v5.mui.com/material-ui/customization/dark-mode/#toggling-color-mode
...
export const UIThemeControls = () => {
    ...
    return <UIThemeSwitch checked={theme === "dark"} onClick={() => (theme === "light" ? setTheme("dark") : setTheme("light"))} />
}

// https://v5.mui.com/material-ui/react-switch/#customization
