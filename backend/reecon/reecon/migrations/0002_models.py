# Generated by Django 5.1.7 on 2025-04-02 00:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("created", models.DateTimeField(auto_now=True, help_text="Date and time of creation.")),
                ("last_processed", models.DateTimeField(auto_now=True, help_text="Date and time when the entity was last processed.")),
                ("username", models.CharField(help_text="The username of the redditor.", max_length=32, unique=True)),
            ],
            options={
                "abstract": False,
